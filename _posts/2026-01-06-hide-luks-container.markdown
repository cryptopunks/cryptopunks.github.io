...
Сохрани его в какое нибудь облако, а с компьютера удали:
...
1. Получаешь заголовок (скачиваешь из своего защищенного источника) и кладёшь его, например, в `/tmp/head.file`.
2. Открываешь контейнер:
...
3. После работы размонтируй ФС и закрой контейнер:
